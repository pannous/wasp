#ifndef TEST_FFI_EXTENDED_H
#define TEST_FFI_EXTENDED_H
...
static void test_ffi_signature_coverage() {
    ...
    check_equals(sig_strcmp, "int32 (char*, char*)");
    ...
    check_equals(sig_trig, "float64 (float64)");
    #endif
}

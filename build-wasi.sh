...
export NODE_PATH=/opt/homebrew/lib/node_modules/ # WHY??
...
# --entry=main,
clang -std=c++2a -fno-builtin -DWASM=1 -DWASI=1 -lm --sysroot=/opt/wasm/wasi-sdk/share/wasi-sysroot -w -Wl,--demangle,--allow-undefined source/Wasp.cpp source/String.cpp source/Node.cpp source/Wasm_Helpers.cpp source/Angle.cpp source/exceptions.cpp source/wasm_emitter.cpp   -o wasp.wasm || exit


# COMPILE FROM .o files WORKS!!
# /opt/wasm/wasi-sdk/bin/clang   -std=c++2a -B=/opt/wasm/wasi-sdk/bin/ -DWASM=1 -nostdlib -march=wasm  -w -v -Xlinker -t -Xlinker --verbose -Wl,--entry=main,--demangle,--allow-undefined -L/usr/local/opt/llvm/lib CMakeFiles/angle.dir/source/String.cpp.o CMakeFiles/angle.dir/source/Node.cpp.o CMakeFiles/angle.dir/source/Wasp.cpp.o CMakeFiles/angle.dir/source/Wasm_Helpers.cpp.o  -o wasp.wasm 

...
//			snprintef(buf, sizeof(buf), "%s:%d \n", info.dli_fname, line_nr); wasp:42  eXECutable makes no SenSe!
    ...
    printef("%s\n", cStr);
//	printef("/me/dev/script/wasm/wasp/tests.cpp:196:10 << TODO: correct line use assert_is()\n");

...
//		WABT_PRINTF_FORMAT(2, 3)
	...
	public:
		...
		Result WriteToFile(String filename) {
	...
	public:
		...
		explicit FileStream(String filename, Stream *log_stream = nullptr);

//		explicit FileStream(String filename_str, Stream *log_stream = nullptr);

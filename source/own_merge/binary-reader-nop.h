...
namespace wabt {
    ...
    public:
		...
		Result OnFunction(Index index, Index sig_index) override { return Result::Ok; }
		...
		Result OnAtomicWaitExpr(Opcode, Address64, Address64) override {
			return Result::Ok;
		}
		...
		Result OnAtomicNotifyExpr(Opcode, Address64, Address64) override {
			return Result::Ok;
		}
		...
		Result OnModuleName(String name) override { return Result::Ok; }
		...
		Result OnDylinkNeeded(String so_name) override { return Result::Ok; }
		...
		Result OnComdatBegin(String name, uint32_t flags, Index count) override {
			return Result::Ok;
		}

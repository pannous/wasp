...
struct wasm32_node_struct {
    ...
    Kind kind;
    // int32 TODO needs padding in Node ( 64 bit ) how? PUT IN node_type(pointer). MIX GENERICS complicated :(
    int meta_pointer;
...
public:
    ...
    Value value = {.longy = 0};
    // value.node and next are NOT REDUNDANT  label(for:password):'Passwort' but children could be merged!?

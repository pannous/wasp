...
static chars function_list[] = {
    ...
    "formatLong","ftoa","ltoa", "itoa","itoa0", "atol", "atoi", "parseInt",
...
struct ParserOptions {
    ...
    // generic list<abc> , "less than" requires spaces, a<b can still be resolved as 'smaller' in analyzer
    bool kebab_case = true;
    // ;// kebab-case means: parse "-" as hypen instead of minus, or 1900 - 2000AD (easy with units)
    bool kebab_case_plus = false;
    //  parse ANY "-" as hypen instead of minus      // a-b can still be resolved as minus in analyzer

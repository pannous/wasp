...
# -Os -Oz ok? -O1 removes symbols!
clang_options="-g  --target=wasm32-unknown-unknown--wasm -nostartfiles -nostdlib -Wl,--demangle,--no-entry,--export-all,--export-table,--allow-undefined"
clang_options="$clang_options -fdebug-pass-arguments -fdebug-pass-structure "
...
# 
$clang $clang_options t.c -o t.wasm || exit

...
list.
push_front(MakeUnique<TestObject>(1)
);
list.
push_front(MakeUnique<TestObject>(2)
);
list.
push_front(MakeUnique<TestObject>(3)
);
...
list.
push_back(MakeUnique<TestObject>(1)
);
list.
push_back(MakeUnique<TestObject>(2)
);
list.
push_back(MakeUnique<TestObject>(3)
);
...
list.
push_front(TestObject(1)
);
list.
push_front(TestObject(2)
);
list.
push_front(TestObject(3)
);
...
list.
push_back(TestObject(1)
);
list.
push_back(TestObject(2)
);
list.
push_back(TestObject(3)
);
...
end(), MakeUnique<TestObject>(4)

);
list.
insert(std::next(list.begin()), MakeUnique<TestObject>(3)
);
list.
insert(list
.

begin(), MakeUnique<TestObject>(1)
...
list.
insert(std::next(list.begin()), TestObject(3)
);
list.
insert(list
.
...
// Erase [3, 4] => [2, 5]
list.
erase(std::next(list.begin()), std::prev(list.end())
);
AssertListEq(list,
{
2, 5});
...
list1.
splice(std::next(list1.begin(), 4), list4
);
AssertListEq(list1,
{
100, 200, 1, 2, 400, 3, 500, 600, 700});
AssertListEq(list4,
{
});
}
...
// Splice in the middle.
list1.
splice(std::next(list1.begin(), 4), NewList({400})
);
AssertListEq(list1,
{
100, 200, 1, 2, 400, 3, 500, 600, 700});
...
end(), list3, std::next(list3.begin(), 2)
...
TestObjectList list4 = NewList({400});
list1.
splice(std::next(list1.begin(), 3), list4, list4
.
...
end(), list3, std::next(list3.begin()), list3
...
TestObjectList list4 = NewList({400});
list1.
splice(std::next(list1.begin(), 4), list4, list4
.

(module
  ...
  (type (;8;) (func (param i32 f64) (result f64)))
  (type (;9;) (func (param i32) (result f64)))
  (type (;10;) (func (param i64) (result i32)))
  (type (;11;) (func (param f64 i64 i64) (result f64)))



  ;;(import "env" "putf" (func $putf (param f64)))
  ...
  ;;  )
  ;;)
  (func $__math_invalid (type 7) (param f64) (result f64)
    local.get 0
    local.get 0
    f64.sub
    local.tee 0
    local.get 0
    f64.div)
  (func $__math_xflow (type 8) (param i32 f64) (result f64)
    local.get 1
    f64.neg
    local.get 1
    local.get 0
    ...
    local.get 1
    f64.mul)
  (func $__math_oflow (type 9) (param i32) (result f64)
    local.get 0
  ...
  (func $__math_uflow (type 9) (param i32) (result f64)
    local.get 0
    ...
    nop
    nop)
  (func $pow (type 3) (param f64 f64) (result f64)
    ...
    local.get 10)
  (func $checkint (type 10) (param i64) (result i32)
    (local i32 i32 i64)
    i32.const 0
    local.set 1
    block
    ...
    local.get 1)
  (func $specialcase (type 11) (param f64 i64 i64) (result f64)

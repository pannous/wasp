...
// so that we can later draw it
    function loadModel() {
        loaded3dModel = LoadWavefrontObj(gl, modelJSON, {
            textureImage: image
        })
        console.log(loaded3dModel)
    }
}
...
// fetch('./f16-model.json').then(response=>modelJSON=response.json())
// fetch('./f16-model.json').then(response=>response.json().then(json=>{modelJSON=json;draw()}))
...
// },{"load-wavefront-obj":12}],2:[function(require,module,exports){
function loadWFObj(require, module, exports) {
    return LoadWavefrontObj(require, module, exports)
}
...
// },{"./expand-vertex-indices.js":11}],11:[function(require,module,exports){
...
// },{"./dedupe-vertex-indices.js":10,"./shader/init-shader.js":15,"./texture/init-texture.js":16,"gl-mat3/normal-from-mat4":2,"gl-mat4/create":3,"gl-mat4/multiply":4,"gl-mat4/perspective":5,"gl-mat4/rotateX":6,"gl-mat4/rotateY":7,"gl-mat4/rotateZ":8,"gl-mat4/translate":9,"xtend":17}],13:[function(require,module,exports){
// module.exports = CreateFragmentShader
...
// },{"./create-fragment-shader.js":13,"./create-vertex-shader.js":14}],16:[function(require,module,exports){
